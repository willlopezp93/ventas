<table class="table table-bordered table-condensed table-hover" id="relacion_reporte">
  ...
  <tbody>
    <?php foreach ($analisis as $key): ?>
      <tr>
        <td><?php echo str_pad($key['cotizacion'], 7, "0", STR_PAD_LEFT); ?></td>
        <td><?php echo date('Y-m-d',strtotime($key['fecha']) )?></td>
        ...
        <?php if ($key['fecha1']==''): ?>
        <td class="excel_fecha1" width="80px"><?php echo '' ?></td>
        <?php else: ?>
        ...
        <?php if ($key['fecha2']==''): ?>
        <td class="excel_fecha2" width="80px"><?php echo '' ?></td>
        <?php else: ?>
        ...
        <?php if ($key['fecha3']==''): ?>
        <td class="excel_fecha3" width="80px"><?php echo '' ?></td>
        <?php else: ?>
