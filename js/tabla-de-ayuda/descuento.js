$(document).ready(function(){
	control_de_menu($('#menu_descuento'));
...
$(document).on('click','#buscar',function(e){
    ...
    $.post(baseurl+"Articulo/descuento",{tipo:tipo,cadena:cadena},function(data){
...
$(document).on('click','.editar',function(e){
	...
	$('#descuento').val(fila.find('td').eq(3).html());
...
if ($('#motivo').val()=='') {
	...
	$.ajax({
		url:baseurl+"Articulo/savedescuento",
		type:"post",
